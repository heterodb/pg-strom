...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Fluentd output plugin for Apache Arrow/Parquet files.}
  spec.description   = %q{Fluentd output plugin for Apache Arrow/Parquet files. See documentation for more details.}
  ...
  test_files, files  = "Gemfile Makefile \
                        ...
                        ext/arrow_file_write/arrow_ruby.cpp \
  ...
  spec.add_runtime_dependency "fluentd", [">= 1.19.1", "< 2"]
