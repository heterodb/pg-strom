...
CREATE TABLE ptable__p0__2017 PARTITION OF ptable__p0
       FOR VALUES FROM ('2017-01-01') TO ('2018-01-01');
CREATE TABLE ptable__p0__2018 PARTITION OF ptable__p0
       FOR VALUES FROM ('2018-01-01') TO ('2019-01-01');
CREATE TABLE ptable__p0__2019 PARTITION OF ptable__p0
       FOR VALUES FROM ('2019-01-01') TO ('2020-01-01');

CREATE TABLE ptable__p1__2017 PARTITION OF ptable__p1
       FOR VALUES FROM ('2017-01-01') TO ('2018-01-01');
CREATE TABLE ptable__p1__2018 PARTITION OF ptable__p1
       FOR VALUES FROM ('2018-01-01') TO ('2019-01-01');
CREATE TABLE ptable__p1__2019 PARTITION OF ptable__p1
       FOR VALUES FROM ('2019-01-01') TO ('2020-01-01');

CREATE TABLE ptable__p2__2017 PARTITION OF ptable__p2
       FOR VALUES FROM ('2017-01-01') TO ('2018-01-01');
CREATE TABLE ptable__p2__2018 PARTITION OF ptable__p2
       FOR VALUES FROM ('2018-01-01') TO ('2019-01-01');
CREATE TABLE ptable__p2__2019 PARTITION OF ptable__p2
       FOR VALUES FROM ('2019-01-01') TO ('2020-01-01');
...
INSERT INTO rtable (
  SELECT x, CASE pgstrom.random_int(0.1) % 28
			...
			pgstrom.random_date(0, '2017-01-01','2019-12-31'),
            md5(x::text)
...
INSERT INTO ctable (SELECT x, pgstrom.random_float(0, 0.0, 100.0)
                      FROM generate_series(1,20000) x);
INSERT INTO dtable
      (SELECT x, ymd, pgstrom.random_float(0, 0.0, 100.0)
         FROM (SELECT row_number() OVER () x, ymd 
	             FROM (SELECT distinct
				              pgstrom.random_date(0, '2016-10-01',
                                                     '2020-03-31') ymd
                         FROM generate_series(1,1000)) subqry_1) subqry_2);
