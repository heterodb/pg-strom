...
\! pg2arrow --progress --set=timezone:Asia/Tokyo -c 'SELECT * FROM regtest_arrow_cpu_temp.regtest_data' -o /home/onishi/pg-strom/./test/13/test_arrow_cpu_1.data

IMPORT FOREIGN SCHEMA regtest_arrow
  FROM SERVER arrow_fdw
  INTO regtest_arrow_cpu_temp
OPTIONS (file '/home/onishi/pg-strom/./test/13/test_arrow_cpu_1.data');
...
\! pg2arrow --progress -c 'SELECT * FROM regtest_arrow_cpu_temp.timezone_data' -o /home/onishi/pg-strom/./test/13/test_arrow_cpu_2.data
IMPORT FOREIGN SCHEMA timezone_arrow
  FROM SERVER arrow_fdw
  INTO regtest_arrow_cpu_temp
OPTIONS (file '/home/onishi/pg-strom/./test/13/test_arrow_cpu_2.data');
