...
\! pg2arrow --progress -c 'SELECT * FROM regtest_arrow_utils_temp.tt_1' -o /home/onishi/pg-strom/./test/13/test_pg2arrow_tt1.arrow

IMPORT FOREIGN SCHEMA ft_1
  FROM SERVER arrow_fdw
  INTO regtest_arrow_utils_temp
OPTIONS (file '/home/onishi/pg-strom/./test/13/test_pg2arrow_tt1.arrow');
...
\! pg2arrow --progress -c 'SELECT * FROM regtest_arrow_utils_temp.tt_2' -o /home/onishi/pg-strom/./test/13/test_pg2arrow_tt2.arrow

IMPORT FOREIGN SCHEMA ft_2
  FROM SERVER arrow_fdw
  INTO regtest_arrow_utils_temp
OPTIONS (file '/home/onishi/pg-strom/./test/13/test_pg2arrow_tt2.arrow');
...
-- Append mode
--
\! pg2arrow --progress -c 'SELECT id+3000,-i2,-i4,-i8,-f2,-f4,-f8,c,-num FROM regtest_arrow_utils_temp.tt_1' --append /home/onishi/pg-strom/./test/13/test_pg2arrow_tt1.arrow
