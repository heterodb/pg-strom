...
#define STROMCL_VRALENA_TYPE_TEMPLATE(NAME,BASE)	\
	STROMCL_VARLENA_DATATYPE_TEMPLATE(NAME,BASE)	\
	STROMCL_VARLENA_VARREF_TEMPLATE(NAME,BASE)		\
	STROMCL_VARLENA_PARAMREF_TEMPLATE(NAME,BASE)
