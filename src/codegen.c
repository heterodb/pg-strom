...
static devfunc_catalog_t devfunc_common_catalog[] = {
	...
	{ "timestamp_mi", 2, {TIMESTAMPOID, TIMESTAMPOID}, 4, "t/f:timestamp_mi" },
	/* timetz +/- interval => timetz */
	{ "timetz_pl_interval", 2, {TIMETZOID, INTERVALOID}, 4, "t/f:timetz_pl_interval" },
	{ "timetz_mi_interval", 2, {TIMETZOID, INTERVALOID}, 4, "t/f:timetz_mi_interval" },
	/* timestamptz +/- interval => timestamptz */
	{ "timestamptz_pl_interval", 2, {TIMESTAMPTZOID, INTERVALOID}, 4, "t/f:timestamptz_pl_interval" },
	{ "timestamptz_mi_interval", 2, {TIMESTAMPTZOID, INTERVALOID}, 4, "t/f:timestamptz_mi_interval" },
	/* interval operators */
	...
	{ "datetimetz_pl", 2, {DATEOID, TIMETZOID}, 4, "t/f:datetimetz_timestamptz" },
	{ "timestamptz", 2, {DATEOID, TIMETZOID}, 4, "t/f:datetimetz_timestamptz" },
	...
	{ "date_eq_timestamp", 2, {DATEOID, TIMESTAMPOID},  2, "t/f:date_eq_timestamp" },
	{ "date_ne_timestamp", 2, {DATEOID, TIMESTAMPOID},  2, "t/f:date_ne_timestamp" },
	{ "date_lt_timestamp", 2, {DATEOID, TIMESTAMPOID},  2, "t/f:date_lt_timestamp" },
	{ "date_le_timestamp", 2, {DATEOID, TIMESTAMPOID},  2, "t/f:date_le_timestamp" },
	{ "date_gt_timestamp", 2, {DATEOID, TIMESTAMPOID},  2, "t/f:date_gt_timestamp" },
	{ "date_ge_timestamp", 2, {DATEOID, TIMESTAMPOID},  2, "t/f:date_ge_timestamp" },
	{ "date_cmp_timestamp", 2, {DATEOID, TIMESTAMPOID}, 2, "t/f:date_cmp_timestamp" },
	...
	{ "timestamp_eq_date", 2, {TIMESTAMPOID, DATEOID}, 3, "t/f:timestamp_eq_date" },
	{ "timestamp_ne_date", 2, {TIMESTAMPOID, DATEOID}, 3, "t/f:timestamp_ne_date" },
	{ "timestamp_lt_date", 2, {TIMESTAMPOID, DATEOID}, 3, "t/f:timestamp_lt_date" },
	{ "timestamp_le_date", 2, {TIMESTAMPOID, DATEOID}, 3, "t/f:timestamp_le_date" },
	{ "timestamp_gt_date", 2, {TIMESTAMPOID, DATEOID}, 3, "t/f:timestamp_gt_date" },
	{ "timestamp_ge_date", 2, {TIMESTAMPOID, DATEOID}, 3, "t/f:timestamp_ge_date" },
	{ "timestamp_cmp_date", 2, {TIMESTAMPOID, DATEOID}, 3, "t/f:timestamp_cmp_date"},
	/* comparison between timestamptz */
	{ "timestamptz_eq", 2, {TIMESTAMPTZOID, TIMESTAMPTZOID}, 1, "t/f:timestamptz_eq" },
	{ "timestamptz_ne", 2, {TIMESTAMPTZOID, TIMESTAMPTZOID}, 1, "t/f:timestamptz_ne" },
	{ "timestamptz_lt", 2, {TIMESTAMPTZOID, TIMESTAMPTZOID}, 1, "t/f:timestamptz_lt" },
	{ "timestamptz_le", 2, {TIMESTAMPTZOID, TIMESTAMPTZOID}, 1, "t/f:timestamptz_le" },
	{ "timestamptz_gt", 2, {TIMESTAMPTZOID, TIMESTAMPTZOID}, 1, "t/f:timestamptz_gt" },
	{ "timestamptz_ge", 2, {TIMESTAMPTZOID, TIMESTAMPTZOID}, 1, "t/f:timestamptz_ge" },
	{ "timestamptz_cmp", 2, {TIMESTAMPTZOID, TIMESTAMPTZOID}, 1, "t/f:type_compare" },

	/* comparison between date and timestamptz */
	{ "date_lt_timestamptz", 2, {DATEOID, TIMESTAMPTZOID}, 3, "t/f:date_lt_timestamptz" },
	{ "date_le_timestamptz", 2, {DATEOID, TIMESTAMPTZOID}, 3, "t/f:date_le_timestamptz" },
	{ "date_eq_timestamptz", 2, {DATEOID, TIMESTAMPTZOID}, 3, "t/f:date_eq_timestamptz" },
	{ "date_ge_timestamptz", 2, {DATEOID, TIMESTAMPTZOID}, 3, "t/f:date_ge_timestamptz" },
	{ "date_gt_timestamptz", 2, {DATEOID, TIMESTAMPTZOID}, 3, "t/f:date_gt_timestamptz" },
	{ "date_ne_timestamptz", 2, {DATEOID, TIMESTAMPTZOID}, 3, "t/f:date_ne_timestamptz" },

	/* comparison between timestamptz and date */
	{ "timestamptz_lt_date", 2, {TIMESTAMPTZOID, DATEOID}, 3, "t/f:timestamptz_lt_date" },
	{ "timestamptz_le_date", 2, {TIMESTAMPTZOID, DATEOID}, 3, "t/f:timestamptz_le_date" },
	{ "timestamptz_eq_date", 2, {TIMESTAMPTZOID, DATEOID}, 3, "t/f:timestamptz_eq_date" },
	{ "timestamptz_ge_date", 2, {TIMESTAMPTZOID, DATEOID}, 3, "t/f:timestamptz_ge_date" },
	{ "timestamptz_gt_date", 2, {TIMESTAMPTZOID, DATEOID}, 3, "t/f:timestamptz_gt_date" },
	{ "timestamptz_ne_date", 2, {TIMESTAMPTZOID, DATEOID}, 3, "t/f:timestamptz_ne_date" },

	/* comparison between timestamp and timestamptz  */
	{ "timestamp_lt_timestamptz", 2, {TIMESTAMPOID, TIMESTAMPTZOID}, 2, "t/f:timestamp_lt_timestamptz" },
	{ "timestamp_le_timestamptz", 2, {TIMESTAMPOID, TIMESTAMPTZOID}, 2, "t/f:timestamp_le_timestamptz" },
	{ "timestamp_eq_timestamptz", 2, {TIMESTAMPOID, TIMESTAMPTZOID}, 2, "t/f:timestamp_eq_timestamptz" },
	{ "timestamp_ge_timestamptz", 2, {TIMESTAMPOID, TIMESTAMPTZOID}, 2, "t/f:timestamp_ge_timestamptz" },
	{ "timestamp_gt_timestamptz", 2, {TIMESTAMPOID, TIMESTAMPTZOID}, 2, "t/f:timestamp_gt_timestamptz" },
	{ "timestamp_ne_timestamptz", 2, {TIMESTAMPOID, TIMESTAMPTZOID}, 2, "t/f:timestamp_ne_timestamptz" },

	/* comparison between timestamptz and timestamp  */
	{ "timestamptz_lt_timestamp", 2, {TIMESTAMPTZOID, TIMESTAMPOID}, 2, "t/f:timestamptz_lt_timestamp" },
	{ "timestamptz_le_timestamp", 2, {TIMESTAMPTZOID, TIMESTAMPOID}, 2, "t/f:timestamptz_le_timestamp" },
	{ "timestamptz_eq_timestamp", 2, {TIMESTAMPTZOID, TIMESTAMPOID}, 2, "t/f:timestamptz_eq_timestamp" },
	{ "timestamptz_ge_timestamp", 2, {TIMESTAMPTZOID, TIMESTAMPOID}, 2, "t/f:timestamptz_ge_timestamp" },
	{ "timestamptz_gt_timestamp", 2, {TIMESTAMPTZOID, TIMESTAMPOID}, 2, "t/f:timestamptz_gt_timestamp" },
	{ "timestamptz_ne_timestamp", 2, {TIMESTAMPTZOID, TIMESTAMPOID}, 2, "t/f:timestamptz_ne_timestamp" },
	...
	/* overlaps() */
	{ "overlaps", 4, {TIMEOID, TIMEOID, TIMEOID, TIMEOID}, 20, "t/f:overlaps_time" },
	{ "overlaps", 4, {TIMETZOID, TIMETZOID, TIMETZOID, TIMETZOID}, 20, "t/f:overlaps_timetz" },
	{ "overlaps", 4, {TIMESTAMPOID, TIMESTAMPOID, TIMESTAMPOID, TIMESTAMPOID}, 20, "t/f:overlaps_timestamp" },
	{ "overlaps", 4, {TIMESTAMPTZOID, TIMESTAMPTZOID, TIMESTAMPTZOID, TIMESTAMPTZOID}, 20, "t/f:overlaps_timestamptz" },

	/* extract() */
	{ "date_part", 2, {TEXTOID,TIMESTAMPOID},   100, "stE/f:extract_timestamp"},
	{ "date_part", 2, {TEXTOID,TIMESTAMPTZOID}, 100, "stE/f:extract_timestamptz"},
	{ "date_part", 2, {TEXTOID,INTERVALOID},    100, "stE/f:extract_interval"},
	{ "date_part", 2, {TEXTOID,TIMETZOID},      100, "stE/f:extract_timetz"},
	{ "date_part", 2, {TEXTOID,TIMEOID},        100, "stE/f:extract_time"},
	...
	{ "bpcharlt",  2, {BPCHAROID,BPCHAROID},  200, "sc/f:bpcharlt" },
	{ "bpcharle",  2, {BPCHAROID,BPCHAROID},  200, "sc/f:bpcharle" },
	{ "bpchargt",  2, {BPCHAROID,BPCHAROID},  200, "sc/f:bpchargt" },
	{ "bpcharge",  2, {BPCHAROID,BPCHAROID},  200, "sc/f:bpcharge" },
	{ "bpcharcmp", 2, {BPCHAROID, BPCHAROID}, 200, "sc/f:type_compare"},
	{ "length",    1, {BPCHAROID},            2, "sc/f:bpcharlen"},
	{ "texteq",    2, {TEXTOID, TEXTOID},     200, "s/f:texteq" },
	{ "textne",    2, {TEXTOID, TEXTOID},     200, "s/f:textne" },
	{ "text_lt",   2, {TEXTOID, TEXTOID},     200, "sc/f:text_lt" },
	{ "text_le",   2, {TEXTOID, TEXTOID},     200, "sc/f:text_le" },
	{ "text_gt",   2, {TEXTOID, TEXTOID},     200, "sc/f:text_gt" },
	{ "text_ge",   2, {TEXTOID, TEXTOID},     200, "sc/f:text_ge" },
	{ "bttextcmp", 2, {TEXTOID, TEXTOID},     200, "sc/f:type_compare" },
	{ "length",    1, {TEXTOID},              2, "sc/f:textlen" },
	/* LIKE operators */
	{ "like",        2, {TEXTOID, TEXTOID},   9999, "s/f:textlike" },
	{ "textlike",    2, {TEXTOID, TEXTOID},   9999, "s/f:textlike" },
	{ "bpcharlike",  2, {BPCHAROID, TEXTOID}, 9999, "s/f:textlike" },
	{ "notlike",     2, {TEXTOID, TEXTOID},   9999, "s/f:textnlike" },
	{ "textnlike",   2, {TEXTOID, TEXTOID},   9999, "s/f:textnlike" },
	{ "bpcharnlike", 2, {BPCHAROID, TEXTOID}, 9999, "s/f:textnlike" },
	/* ILIKE operators */
	{ "texticlike",    2, {TEXTOID, TEXTOID},   9999, "sc/f:texticlike" },
	{ "bpchariclike",  2, {TEXTOID, TEXTOID},   9999, "sc/f:texticlike" },
	{ "texticnlike",   2, {TEXTOID, TEXTOID},   9999, "sc/f:texticnlike" },
	{ "bpcharicnlike", 2, {BPCHAROID, TEXTOID}, 9999, "sc/f:texticnlike" },
};
...
static devfunc_extra_catalog_t devfunc_extra_catalog[] = {
	...
	{ BOOL,    "pgstrom.float2_eq("FLOAT2","FLOAT2")",  2, "p/f:float2eq" },
	{ BOOL,    "pgstrom.float2_ne("FLOAT2","FLOAT2")",  2, "p/f:float2ne" },
	{ BOOL,    "pgstrom.float2_lt("FLOAT2","FLOAT2")",  2, "p/f:float2lt" },
	{ BOOL,    "pgstrom.float2_le("FLOAT2","FLOAT2")",  2, "p/f:float2le" },
	{ BOOL,    "pgstrom.float2_gt("FLOAT2","FLOAT2")",  2, "p/f:float2gt" },
	{ BOOL,    "pgstrom.float2_ge("FLOAT2","FLOAT2")",  2, "p/f:float2ge" },
	{ BOOL,    "pgstrom.float2_cmp("FLOAT2","FLOAT2")", 2, "p/f:type_compare" },

	{ BOOL,    "pgstrom.float42_eq("FLOAT4","FLOAT2")", 2, "p/f:float42eq" },
	{ BOOL,    "pgstrom.float42_ne("FLOAT4","FLOAT2")", 2, "p/f:float42ne" },
	{ BOOL,    "pgstrom.float42_lt("FLOAT4","FLOAT2")", 2, "p/f:float42lt" },
	{ BOOL,    "pgstrom.float42_le("FLOAT4","FLOAT2")", 2, "p/f:float42le" },
	{ BOOL,    "pgstrom.float42_gt("FLOAT4","FLOAT2")", 2, "p/f:float42gt" },
	{ BOOL,    "pgstrom.float42_ge("FLOAT4","FLOAT2")", 2, "p/f:float42ge" },
	{ BOOL,    "pgstrom.float42_cmp("FLOAT4","FLOAT2")", 2, "p/f:type_compare" },

	{ BOOL,    "pgstrom.float82_eq("FLOAT8","FLOAT2")", 2, "p/f:float82eq" },
	{ BOOL,    "pgstrom.float82_ne("FLOAT8","FLOAT2")", 2, "p/f:float82ne" },
	{ BOOL,    "pgstrom.float82_lt("FLOAT8","FLOAT2")", 2, "p/f:float82lt" },
	{ BOOL,    "pgstrom.float82_le("FLOAT8","FLOAT2")", 2, "p/f:float82le" },
	{ BOOL,    "pgstrom.float82_gt("FLOAT8","FLOAT2")", 2, "p/f:float82gt" },
	{ BOOL,    "pgstrom.float82_ge("FLOAT8","FLOAT2")", 2, "p/f:float82ge" },
	{ BOOL,    "pgstrom.float82_cmp("FLOAT8","FLOAT2")", 2, "p/f:type_compare" },

	{ BOOL,    "pgstrom.float24_eq("FLOAT2","FLOAT4")", 2, "p/f:float24eq" },
	{ BOOL,    "pgstrom.float24_ne("FLOAT2","FLOAT4")", 2, "p/f:float24ne" },
	{ BOOL,    "pgstrom.float24_lt("FLOAT2","FLOAT4")", 2, "p/f:float24lt" },
	{ BOOL,    "pgstrom.float24_le("FLOAT2","FLOAT4")", 2, "p/f:float24le" },
	{ BOOL,    "pgstrom.float24_gt("FLOAT2","FLOAT4")", 2, "p/f:float24gt" },
	{ BOOL,    "pgstrom.float24_ge("FLOAT2","FLOAT4")", 2, "p/f:float24ge" },
	{ BOOL,    "pgstrom.float24_cmp("FLOAT2","FLOAT4")", 2, "p/f:type_compare" },

	{ BOOL,    "pgstrom.float28_eq("FLOAT2","FLOAT8")", 2, "p/f:float28eq" },
	{ BOOL,    "pgstrom.float28_ne("FLOAT2","FLOAT8")", 2, "p/f:float28ne" },
	{ BOOL,    "pgstrom.float28_lt("FLOAT2","FLOAT8")", 2, "p/f:float28lt" },
	{ BOOL,    "pgstrom.float28_le("FLOAT2","FLOAT8")", 2, "p/f:float28le" },
	{ BOOL,    "pgstrom.float28_gt("FLOAT2","FLOAT8")", 2, "p/f:float28gt" },
	{ BOOL,    "pgstrom.float28_ge("FLOAT2","FLOAT8")", 2, "p/f:float28ge" },
	{ BOOL,    "pgstrom.float28_cmp("FLOAT2","FLOAT8")", 2, "p/f:type_compare" },
	...
	{ FLOAT4, "pgstrom.float2_pl("FLOAT2","FLOAT2")",   2, "m/f:float2pl" },
	{ FLOAT4, "pgstrom.float2_mi("FLOAT2","FLOAT2")",   2, "m/f:float2mi" },
	{ FLOAT4, "pgstrom.float2_mul("FLOAT2","FLOAT2")",  3, "m/f:float2mul" },
	{ FLOAT4, "pgstrom.float2_div("FLOAT2","FLOAT2")",  3, "m/f:float2div" },
	{ FLOAT4, "pgstrom.float24_pl("FLOAT2","FLOAT4")",  2, "m/f:float24pl" },
	{ FLOAT4, "pgstrom.float24_mi("FLOAT2","FLOAT4")",  2, "m/f:float24mi" },
	{ FLOAT4, "pgstrom.float24_mul("FLOAT2","FLOAT4")", 3, "m/f:float24mul" },
	{ FLOAT4, "pgstrom.float24_div("FLOAT2","FLOAT4")", 3, "m/f:float24div" },
	{ FLOAT8, "pgstrom.float28_pl("FLOAT2","FLOAT8")",  2, "m/f:float28pl" },
	{ FLOAT8, "pgstrom.float28_mi("FLOAT2","FLOAT8")",  2, "m/f:float28mi" },
	{ FLOAT8, "pgstrom.float28_mul("FLOAT2","FLOAT8")", 3, "m/f:float28mul" },
	{ FLOAT8, "pgstrom.float28_div("FLOAT2","FLOAT8")", 3, "m/f:float28div" },
	{ FLOAT4, "pgstrom.float42_pl("FLOAT4","FLOAT2")",  2, "m/f:float42pl" },
	{ FLOAT4, "pgstrom.float42_mi("FLOAT4","FLOAT2")",  2, "m/f:float42mi" },
	{ FLOAT4, "pgstrom.float42_mul("FLOAT4","FLOAT2")", 3, "m/f:float42mul" },
	{ FLOAT4, "pgstrom.float42_div("FLOAT4","FLOAT2")", 3, "m/f:float42div" },
	{ FLOAT8, "pgstrom.float82_pl("FLOAT8","FLOAT2")",  2, "m/f:float82pl" },
	{ FLOAT8, "pgstrom.float82_mi("FLOAT8","FLOAT2")",  2, "m/f:float82mi" },
	{ FLOAT8, "pgstrom.float82_mul("FLOAT8","FLOAT2")", 3, "m/f:float82mul" },
	{ FLOAT8, "pgstrom.float82_div("FLOAT8","FLOAT2")", 3, "m/f:float82div" },
	{ "money", "pgstrom.cash_mul_flt2(money,"FLOAT2")", 3, "y/f:cash_mul_flt2" },
	{ "money", "pgstrom.flt2_mul_cash("FLOAT2",money)", 3, "y/f:flt2_mul_cash" },
	{ "money", "pgstrom.cash_div_flt2(money,"FLOAT2")", 3, "y/f:cash_div_flt2" },
	...
	{ BOOL, "range_eq(int4range,int4range)",  2, "r/f:generic_range_eq" },
	{ BOOL, "range_ne(int4range,int4range)",  2, "r/f:generic_range_ne" },
	{ BOOL, "range_lt(int4range,int4range)",  2, "r/f:generic_range_lt" },
	{ BOOL, "range_le(int4range,int4range)",  2, "r/f:generic_range_le" },
	{ BOOL, "range_gt(int4range,int4range)",  2, "r/f:generic_range_gt" },
	{ BOOL, "range_ge(int4range,int4range)",  2, "r/f:generic_range_ge" },
	{ INT4, "range_cmp(int4range,int4range)", 2, "r/f:generic_range_cmp" },
	{ BOOL, "range_overlaps(int4range,int4range)",   4, "r/f:generic_range_overlaps" },
	{ BOOL, "range_contains_elem(int4range,"INT4")", 4, "r/f:generic_range_contains_elem" },
	{ BOOL, "range_contains(int4range,int4range)",   4, "r/f:generic_range_contains" },
	{ BOOL, "elem_contained_by_range("INT4",int4range)", 4, "r/f:generic_elem_contained_by_range" },
	{ BOOL, "range_contained_by(int4range,int4range)", 4, "r/f:generic_range_contained_by" },
	{ BOOL, "range_adjacent(int4range,int4range)", 4, "r/f:generic_range_adjacent" },
	{ BOOL, "range_before(int4range,int4range)", 4, "r/f:generic_range_before" },
	{ BOOL, "range_after(int4range,int4range)", 4, "r/f:generic_range_after" },
	{ BOOL, "range_overleft(int4range,int4range)", 4, "r/f:generic_range_overleft" },
	{ BOOL, "range_overright(int4range,int4range)", 4, "r/f:generic_range_overleft" },
	{ "int4range", "range_union(int4range,int4range)", 4, "r/f:generic_range_union" },
	{ "int4range", "range_merge(int4range,int4range)", 4, "r/f:generic_range_merge" },
	{ "int4range", "range_intersect(int4range,int4range)", 4, "r/f:generic_range_intersect" },
	{ "int4range", "range_minus(int4range,int4range)", 4, "r/f:generic_range_minus" },
	...
	{ BOOL, "range_eq(int8range,int8range)",  2, "r/f:generic_range_eq" },
	{ BOOL, "range_ne(int8range,int8range)",  2, "r/f:generic_range_ne" },
	{ BOOL, "range_lt(int8range,int8range)",  2, "r/f:generic_range_lt" },
	{ BOOL, "range_le(int8range,int8range)",  2, "r/f:generic_range_le" },
	{ BOOL, "range_gt(int8range,int8range)",  2, "r/f:generic_range_gt" },
	{ BOOL, "range_ge(int8range,int8range)",  2, "r/f:generic_range_ge" },
	{ INT4, "range_cmp(int8range,int8range)", 2, "r/f:generic_range_cmp" },
	{ BOOL, "range_overlaps(int8range,int8range)", 4, "r/f:generic_range_overlaps" },
	{ BOOL, "range_contains_elem(int8range,"INT8")", 4, "r/f:generic_range_contains_elem" },
	{ BOOL, "range_contains(int8range,int8range)", 4, "r/f:generic_range_contains" },
	{ BOOL, "elem_contained_by_range("INT8",int8range)", 4, "r/f:generic_elem_contained_by_range" },
	{ BOOL, "range_contained_by(int8range,int8range)", 4, "r/f:generic_range_contained_by" },
	{ BOOL, "range_adjacent(int8range,int8range)", 4, "r/f:generic_range_adjacent" },
	{ BOOL, "range_before(int8range,int8range)", 4, "r/f:generic_range_before" },
	{ BOOL, "range_after(int8range,int8range)", 4, "r/f:generic_range_after" },
	{ BOOL, "range_overleft(int8range,int8range)", 4, "r/f:generic_range_overleft" },
	{ BOOL, "range_overright(int8range,int8range)", 4, "r/f:generic_range_overleft" },
	{ "int8range", "range_union(int8range,int8range)", 4, "r/f:generic_range_union" },
	{ "int8range", "range_merge(int8range,int8range)", 4, "r/f:generic_range_merge" },
	{ "int8range", "range_intersect(int8range,int8range)", 4, "r/f:generic_range_intersect" },
	{ "int8range", "range_minus(int8range,int8range)", 4, "r/f:generic_range_minus" },
	...
	{ BOOL, "range_overlaps(tsrange,tsrange)", 4, "r/f:generic_range_overlaps" },
	{ BOOL, "range_contains_elem(tsrange,timestamp)", 4, "r/f:generic_range_contains_elem" },
	{ BOOL, "range_contains(tsrange,tsrange)", 4, "r/f:generic_range_contains" },
	{ BOOL, "elem_contained_by_range(timestamp,tsrange)", 4, "r/f:generic_elem_contained_by_range" },
	{ BOOL, "range_contained_by(tsrange,tsrange)", 4, "r/f:generic_range_contained_by" },
	{ BOOL, "range_adjacent(tsrange,tsrange)", 4, "r/f:generic_range_adjacent" },
	{ BOOL, "range_before(tsrange,tsrange)", 4, "r/f:generic_range_before" },
	{ BOOL, "range_after(tsrange,tsrange)", 4, "r/f:generic_range_after" },
	{ BOOL, "range_overleft(tsrange,tsrange)", 4, "r/f:generic_range_overleft" },
	{ BOOL, "range_overright(tsrange,tsrange)", 4, "r/f:generic_range_overleft" },
	{ "tsrange", "range_union(tsrange,tsrange)", 4, "r/f:generic_range_union" },
	{ "tsrange", "range_merge(tsrange,tsrange)", 4, "r/f:generic_range_merge" },
	{ "tsrange", "range_intersect(tsrange,tsrange)", 4, "r/f:generic_range_intersect" },
	{ "tsrange", "range_minus(tsrange,tsrange)", 4, "r/f:generic_range_minus" },

	/* tstzrange operators */
	{ "timestamptz", "lower(tstzrange)",      2, "r/f:tstzrange_lower" },
	{ "timestamptz", "upper(tstzrange)",      2, "r/f:tstzrange_upper" },
	{ BOOL, "isempty(tstzrange)",             1, "r/f:generic_range_isempty" },
	{ BOOL, "lower_inc(tstzrange)",           1, "r/f:generic_range_lower_inc" },
	{ BOOL, "upper_inc(tstzrange)",           1, "r/f:generic_range_upper_inc" },
	{ BOOL, "lower_inf(tstzrange)",           1, "r/f:generic_range_lower_inf" },
	{ BOOL, "upper_inf(tstzrange)",           1, "r/f:generic_range_upper_inf" },
	{ BOOL, "range_eq(tstzrange,tstzrange)",  2, "r/f:generic_range_eq" },
	{ BOOL, "range_ne(tstzrange,tstzrange)",  2, "r/f:generic_range_ne" },
	{ BOOL, "range_lt(tstzrange,tstzrange)",  2, "r/f:generic_range_lt" },
	{ BOOL, "range_le(tstzrange,tstzrange)",  2, "r/f:generic_range_le" },
	{ BOOL, "range_gt(tstzrange,tstzrange)",  2, "r/f:generic_range_gt" },
	{ BOOL, "range_ge(tstzrange,tstzrange)",  2, "r/f:generic_range_ge" },
	{ INT4, "range_cmp(tstzrange,tstzrange)", 2, "r/f:generic_range_cmp" },
	{ BOOL, "range_overlaps(tstzrange,tstzrange)", 4, "r/f:generic_range_overlaps" },
	{ BOOL, "range_contains_elem(tstzrange,timestamptz)", 4, "r/f:generic_range_contains_elem" },
	{ BOOL, "range_contains(tstzrange,tstzrange)", 4, "r/f:generic_range_contains" },
	{ BOOL, "elem_contained_by_range(timestamptz,tstzrange)", 4, "r/f:generic_elem_contained_by_range" },
	{ BOOL, "range_contained_by(tstzrange,tstzrange)", 4, "r/f:generic_range_contained_by" },
	{ BOOL, "range_adjacent(tstzrange,tstzrange)", 4, "r/f:generic_range_adjacent" },
	{ BOOL, "range_before(tstzrange,tstzrange)", 4, "r/f:generic_range_before" },
	{ BOOL, "range_after(tstzrange,tstzrange)", 4, "r/f:generic_range_after" },
	{ BOOL, "range_overleft(tstzrange,tstzrange)", 4, "r/f:generic_range_overleft" },
	{ BOOL, "range_overright(tstzrange,tstzrange)", 4, "r/f:generic_range_overleft" },
	{ "tstzrange", "range_union(tstzrange,tstzrange)", 4, "r/f:generic_range_union" },
	{ "tstzrange", "range_merge(tstzrange,tstzrange)", 4, "r/f:generic_range_merge" },
	{ "tstzrange", "range_intersect(tstzrange,tstzrange)", 4, "r/f:generic_range_intersect" },
	{ "tstzrange", "range_minus(tstzrange,tstzrange)", 4, "r/f:generic_range_minus" },
	...
	{ BOOL, "range_eq(daterange,daterange)",  4, "r/f:generic_range_eq" },
	{ BOOL, "range_ne(daterange,daterange)",  4, "r/f:generic_range_ne" },
	{ BOOL, "range_lt(daterange,daterange)",  4, "r/f:generic_range_lt" },
	{ BOOL, "range_le(daterange,daterange)",  4, "r/f:generic_range_le" },
	{ BOOL, "range_gt(daterange,daterange)",  4, "r/f:generic_range_gt" },
	{ BOOL, "range_ge(daterange,daterange)",  4, "r/f:generic_range_ge" },
	{ INT4, "range_cmp(daterange,daterange)", 4, "r/f:generic_range_cmp" },
	{ BOOL, "range_overlaps(daterange,daterange)", 4, "r/f:generic_range_overlaps" },
	{ BOOL, "range_contains_elem(daterange,date)", 4, "r/f:generic_range_contains_elem" },
	{ BOOL, "range_contains(daterange,daterange)", 4, "r/f:generic_range_contains" },
	{ BOOL, "elem_contained_by_range(date,daterange)", 4, "r/f:generic_elem_contained_by_range" },
	{ BOOL, "range_contained_by(daterange,daterange)", 4, "r/f:generic_range_contained_by" },
	{ BOOL, "range_adjacent(daterange,daterange)", 4, "r/f:generic_range_adjacent" },
	{ BOOL, "range_before(daterange,daterange)", 4, "r/f:generic_range_before" },
	{ BOOL, "range_after(daterange,daterange)", 4, "r/f:generic_range_after" },
	{ BOOL, "range_overleft(daterange,daterange)", 4, "r/f:generic_range_overleft" },
	{ BOOL, "range_overright(daterange,daterange)", 4, "r/f:generic_range_overleft" },
	{ "daterange", "range_union(daterange,daterange)", 4, "r/f:generic_range_union" },
	{ "daterange", "range_merge(daterange,daterange)", 4, "r/f:generic_range_merge" },
	{ "daterange", "range_intersect(daterange,daterange)", 4, "r/f:generic_range_intersect" },
	{ "daterange", "range_minus(daterange,daterange)", 4, "r/f:generic_range_minus" },
...
static bool
device_expression_walker(Expr *expr, device_expression_walker_context *con)
{
	if (expr == NULL)
		return true;
	if (IsA(expr, List))
	{
		...
		{
			if (!device_expression_walker(lfirst(cell), con))
				return false;
		}
		return true;
	}
	...
	else if (IsA(expr, FuncExpr))
	{
		...
		return device_expression_walker((Expr *) func->args, con);
	}
	else if (IsA(expr, OpExpr) || IsA(expr, DistinctExpr))
	{
		...
		if (!dfunc)
			goto unable_node;
		con->devcost += dfunc->func_devcost;
		return device_expression_walker((Expr *) op->args, con);
	}
	else if (IsA(expr, NullTest))
	{
		...
		con->devcost += 1;
		return device_expression_walker((Expr *) nulltest->arg, con);
	}
	else if (IsA(expr, BooleanTest))
	{
		...
		con->devcost += 1;
		return device_expression_walker((Expr *) booltest->arg, con);
	}
	else if (IsA(expr, BoolExpr))
	{
		...
		return device_expression_walker((Expr *) boolexpr->args, con);
	}
	else if (IsA(expr, CoalesceExpr))
	{
		...
		return device_expression_walker((Expr *) coalesce->args, con);
	}
	else if (IsA(expr, MinMaxExpr))
	{
		...
		return device_expression_walker((Expr *) minmax->args, con);
	}
	else if (IsA(expr, RelabelType))
	{
		...
		return device_expression_walker((Expr *) relabel->arg, con);
	}
	else if (IsA(expr, CaseExpr))
	{
		...
		if (caseexpr->arg)
		{
			if (!device_expression_walker(caseexpr->arg, con))
				return false;
		}
		...
		foreach (cell, caseexpr->args)
		{
			...
			if (!device_expression_walker(casewhen->expr, con))
				return false;
			if (!device_expression_walker(casewhen->result, con))
				return false;
		}
		if (!device_expression_walker((Expr *)caseexpr->defresult, con))
			return false;
		return true;
	}
	...
	else if (IsA(expr, ScalarArrayOpExpr))
	{
		...
		if (!device_expression_walker((Expr *) opexpr->args, con))
			return false;
		/*
...
__pgstrom_device_expression(Expr *expr, const char *filename, int lineno)
{
	...
	return device_expression_walker(expr, &con);
}

bool
__pgstrom_device_expression_cost(Expr *expr, int *p_devcost,
								 const char *filename, int lineno)
{
	...
	if (!device_expression_walker(expr, &con))
		return false;
