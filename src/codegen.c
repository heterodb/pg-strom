...
static devfunc_catalog_t devfunc_common_catalog[] = {
	...
	{ "cbrt",    1, {FLOAT8OID}, 1, "y/f:cbrt" },
	{ "dcbrt",   1, {FLOAT8OID}, 1, "y/f:cbrt" },
	{ "ceil",    1, {FLOAT8OID}, 1, "y/f:ceil" },
	{ "ceiling", 1, {FLOAT8OID}, 1, "y/f:ceil" },
	{ "exp",     1, {FLOAT8OID}, 5, "y/f:exp" },
	{ "dexp",    1, {FLOAT8OID}, 5, "y/f:exp" },
	{ "floor",   1, {FLOAT8OID}, 1, "y/f:floor" },
	{ "ln",      1, {FLOAT8OID}, 5, "y/f:ln" },
	{ "dlog1",   1, {FLOAT8OID}, 5, "y/f:ln" },
	{ "log",     1, {FLOAT8OID}, 5, "y/f:log10" },
	{ "dlog10",  1, {FLOAT8OID}, 5, "y/f:log10" },
	{ "pi",      0, {}, 0, "y/f:dpi" },
	{ "power",   2, {FLOAT8OID, FLOAT8OID}, 5, "y/f:dpow" },
	{ "pow",     2, {FLOAT8OID, FLOAT8OID}, 5, "y/f:dpow" },
	{ "dpow",    2, {FLOAT8OID, FLOAT8OID}, 5, "y/f:dpow" },
	{ "round",   1, {FLOAT8OID}, 5, "y/f:round" },
	{ "dround",  1, {FLOAT8OID}, 5, "y/f:round" },
	{ "sign",    1, {FLOAT8OID}, 1, "y/f:sign" },
	{ "sqrt",    1, {FLOAT8OID}, 5, "y/f:dsqrt" },
	{ "dsqrt",   1, {FLOAT8OID}, 5, "y/f:dsqrt" },
	{ "trunc",   1, {FLOAT8OID}, 1, "y/f:trunc" },
	{ "dtrunc",  1, {FLOAT8OID}, 1, "y/f:trunc" },

	/*
     * Trigonometric function
     */
	{ "degrees", 1, {FLOAT8OID}, 5, "y/f:degrees" },
	{ "radians", 1, {FLOAT8OID}, 5, "y/f:radians" },
	{ "acos",    1, {FLOAT8OID}, 5, "y/f:acos" },
	{ "asin",    1, {FLOAT8OID}, 5, "y/f:asin" },
	{ "atan",    1, {FLOAT8OID}, 5, "y/f:atan" },
	{ "atan2",   2, {FLOAT8OID, FLOAT8OID}, 5, "y/f:atan2" },
	{ "cos",     1, {FLOAT8OID}, 5, "y/f:cos" },
	{ "cot",     1, {FLOAT8OID}, 5, "y/f:cot" },
	{ "sin",     1, {FLOAT8OID}, 5, "y/f:sin" },
	{ "tan",     1, {FLOAT8OID}, 5, "y/f:tan" },
