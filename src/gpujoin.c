						 ...
						 List *host_quals)
{
	...
	/*
	 * FIXME: In our heuristics, too small nrows_ratio tends to be wrong
	 * of relation size estimation or table statistics.
	 * That is a workaround to run DBT-3!
	 */
	nrows_ratio = Max(nrows_ratio, 0.25);
