...
#endif
TYPE_OPCODE(bool, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(int1, "pg_strom", DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(int2, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(int4, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(int8, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(float2, "pg_strom", DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(float4, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(float8, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(numeric,NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(bytea, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(text,  NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(bpchar, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(date, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(time, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(timetz, NULL, DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(timestamp,   NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(timestamptz, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(interval, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(money, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(uuid, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(macaddr, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(inet, NULL, DEVTYPE__HAS_COMPARE|DEVTYPE__HAS_DEVHASH)
TYPE_OPCODE(jsonb, NULL, DEVTYPE__HAS_DEVHASH)
...
/* type device hash functions */
__FUNC_OPCODE(bool_devhash,    bool/int8,    2, "pg_strom")
__FUNC_OPCODE(int1_devhash,    int1/int8,    2, "pg_strom")
__FUNC_OPCODE(int2_devhash,    int2/int8,    2, "pg_strom")
__FUNC_OPCODE(int4_devhash,    int4/int8,    2, "pg_strom")
__FUNC_OPCODE(int8_devhash,    int8/int8,    2, "pg_strom")
__FUNC_OPCODE(float2_devhash,  float2/int8,  2, "pg_strom")
__FUNC_OPCODE(float4_devhash,  float4/int8,  2, "pg_strom")
__FUNC_OPCODE(float8_devhash,  float8/int8,  2, "pg_strom")
__FUNC_OPCODE(numeric_devhash, numeric/int8, 2, "pg_strom")
__FUNC_OPCODE(bytea_devhash,   bytea/int8,   2, "pg_strom")
__FUNC_OPCODE(text_devhash,    text/int8,    2, "pg_strom")
__FUNC_OPCODE(bpchar_devhash,  bpchar/int8,  2, "pg_strom")
__FUNC_OPCODE(date_devhash,    date/int8,    2, "pg_strom")
__FUNC_OPCODE(time_devhash,    time/int8,    2, "pg_strom")
__FUNC_OPCODE(timetz_devhash,  timetz/int8,  2, "pg_strom")
__FUNC_OPCODE(timestamp_devhash, timestamp/int8, 2, "pg_strom")
__FUNC_OPCODE(timestamptz_devhash, timestamptz/int8, 2, "pg_strom")
__FUNC_OPCODE(money_devhash,   money/int8,   2, "pg_strom")
__FUNC_OPCODE(uuid_devhash,    uuid/int8,    2, "pg_strom")
__FUNC_OPCODE(macaddr_devhash, macaddr/int8, 2, "pg_strom")
__FUNC_OPCODE(inet_devhash,    inet/int8,    2, "pg_strom")
__FUNC_OPCODE(jsonb_devhash,   jsonb/int8,   2, "pg_strom")
