...
#endif
TYPE_OPCODE(bool, NULL, 0)
TYPE_OPCODE(int1, "pg_strom", 0)
TYPE_OPCODE(int2, NULL, 0)
TYPE_OPCODE(int4, NULL, 0)
TYPE_OPCODE(int8, NULL, 0)
TYPE_OPCODE(float2, "pg_strom", 0)
TYPE_OPCODE(float4, NULL, 0)
TYPE_OPCODE(float8, NULL, 0)
TYPE_OPCODE(numeric,NULL, DEVTYPE__USE_KVARS_SLOTBUF)
TYPE_OPCODE(bytea, NULL, 0)
TYPE_OPCODE(text,  NULL, 0)
TYPE_OPCODE(bpchar, NULL, 0)
TYPE_OPCODE(date, NULL, 0)
TYPE_OPCODE(time, NULL, 0)
TYPE_OPCODE(timetz, NULL, 0)
TYPE_OPCODE(timestamp,   NULL, 0)
TYPE_OPCODE(timestamptz, NULL, 0)
TYPE_OPCODE(interval, NULL, DEVTYPE__USE_KVARS_SLOTBUF)
TYPE_OPCODE(money, NULL, 0)
