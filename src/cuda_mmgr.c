 ...
 * It is originated from utils/mmgr/aset.c of PostgreSQL.
 * ----
...
/* ----------
 * alloc_block_malloc() / alloc_block_free() - alternative routines to
...
static void
alloc_block_free(AllocBlock block)
{
	CUresult	rc;
