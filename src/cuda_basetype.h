...
PG_SIMPLE_TYPECAST_TEMPLATE(int2,float2,cl_short)
...
PG_SIMPLE_TYPECAST_TEMPLATE(int4,float2,cl_int)
...
PG_SIMPLE_TYPECAST_TEMPLATE(int8,float2,cl_long)
PG_SIMPLE_TYPECAST_TEMPLATE(int8,float4,cl_long)
PG_SIMPLE_TYPECAST_TEMPLATE(int8,float8,cl_long)
