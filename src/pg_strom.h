...
extern Datum float8_to_matrix(PG_FUNCTION_ARGS);
extern Datum matrix_to_float8(PG_FUNCTION_ARGS);
extern Datum numeric_to_matrix(PG_FUNCTION_ARGS);
extern Datum matrix_to_numeric(PG_FUNCTION_ARGS);
