...
#define DEVKERNEL_NEEDS_GPUSCAN_BODY	0x00000010	/* GpuScan logic */
#define DEVKERNEL_NEEDS_GPUJOIN_BODY	0x00000020	/* GpuJoin logic */
#define DEVKERNEL_NEEDS_GPUPREAGG_BODY	0x00000040	/* GpuPreAgg logic */
#define DEVKERNEL_NEEDS_GPUSORT_BODY	0x00000080	/* GpuSort logic */
#define DEVKERNEL_NEEDS_GPUSCAN			0x00000011	/* GpuScan all */
#define DEVKERNEL_NEEDS_GPUJOIN			0x00000022	/* GpuJoin all */
...
#define DEVKERNEL_NEEDS_JSONLIB			0x00005800	/* +textlib,numeric */
#define DEVKERNEL_NEEDS_MISC			0x00008000
#define DEVKERNEL_NEEDS_RANGETYPE		0x00010000
#define DEVKERNEL_NEEDS_PRIMITIVE		0x00020000
#define DEVKERNEL_NEEDS_TIME_EXTRACT	0x00040400	/* +timelib */
