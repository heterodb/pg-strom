					   ...
					   Datum           *tup_values)
{
	...
	cl_int		tup_extra[GPUPREAGG_DEVICE_PROJECTION_NFIELDS];
#else
	cl_int	   *tup_extra = NULL;
#endif
					...
					kern_data_store *kds_slot)	/* out: KDS_FORMAT_SLOT */
{
	...
	cl_uint			nvalids;
#if GPUPREAGG_DEVICE_PROJECTION_NFIELDS > 0
	cl_char			tup_dclass[GPUPREAGG_DEVICE_PROJECTION_NFIELDS];
