...
/* numeric functions */
FUNC_OPCODE(int1, numeric, DEVKERN__ANY, numeric_to_int1, "pg_strom")
FUNC_OPCODE(int2, numeric, DEVKERN__ANY, numeric_to_int2, NULL)
FUNC_OPCODE(int4, numeric, DEVKERN__ANY, numeric_to_int4, NULL)
FUNC_OPCODE(int8, numeric, DEVKERN__ANY, numeric_to_int8, NULL)
FUNC_OPCODE(float2, numeric, DEVKERN__ANY, numeric_to_float2, "pg_strom")
FUNC_OPCODE(float4, numeric, DEVKERN__ANY, numeric_to_float4, NULL)
FUNC_OPCODE(float8, numeric, DEVKERN__ANY, numeric_to_float8, NULL)
FUNC_OPCODE(money, numeric, DEVKERN__ANY, numeric_to_money, NULL)
FUNC_OPCODE(numeric, int1, DEVKERN__ANY, int1_to_numeric, "pg_strom")
FUNC_OPCODE(numeric, int2, DEVKERN__ANY, int2_to_numeric, NULL)
FUNC_OPCODE(numeric, int4, DEVKERN__ANY, int4_to_numeric, NULL)
FUNC_OPCODE(numeric, int8, DEVKERN__ANY, int8_to_numeric, NULL)
FUNC_OPCODE(numeric, float2, DEVKERN__ANY, float2_to_numeric, "pg_strom")
FUNC_OPCODE(numeric, float4, DEVKERN__ANY, float4_to_numeric, NULL)
FUNC_OPCODE(numeric, float8, DEVKERN__ANY, float8_to_numeric, NULL)
FUNC_OPCODE(numeric, money, DEVKERN__ANY, money_to_numeric, NULL)
__FUNC_OPCODE(numeric_add, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_sub, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_mul, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_div, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_mod, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_uplus, numeric, NULL)
__FUNC_OPCODE(numeric_uminus, numeric, NULL)	
__FUNC_OPCODE(numeric_abs, numeric, NULL)
__FUNC_OPCODE(numeric_eq, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_ne, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_lt, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_le, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_gt, numeric/numeric, NULL)
__FUNC_OPCODE(numeric_ge, numeric/numeric, NULL)

/* Date and time functions */
FUNC_OPCODE(timestamp, date, DEVKERN__ANY, date_to_timestamp, NULL)
FUNC_OPCODE(timestamp, timestamptz, DEVKERN__ANY, timestamptz_to_timestamp, NULL)
FUNC_OPCODE(timestamptz, date, DEVKERN__ANY|DEVKERN__SESSION_TIMEZONE, date_to_timestamptz, NULL)
FUNC_OPCODE(timestamptz, timestamp, DEVKERN__ANY, timestamp_to_timestamptz, NULL)

__FUNC_OPCODE(date_eq, date/date, NULL)
__FUNC_OPCODE(date_ne, date/date, NULL)
__FUNC_OPCODE(date_lt, date/date, NULL)
__FUNC_OPCODE(date_le, date/date, NULL)
__FUNC_OPCODE(date_gt, date/date, NULL)
__FUNC_OPCODE(date_ge, date/date, NULL)

__FUNC_OPCODE(time_eq, time/time, NULL)
__FUNC_OPCODE(time_ne, time/time, NULL)
__FUNC_OPCODE(time_lt, time/time, NULL)
__FUNC_OPCODE(time_le, time/time, NULL)
__FUNC_OPCODE(time_gt, time/time, NULL)
__FUNC_OPCODE(time_ge, time/time, NULL)

__FUNC_OPCODE(timetz_eq, timetz/timetz, NULL)
__FUNC_OPCODE(timetz_ne, timetz/timetz, NULL)
__FUNC_OPCODE(timetz_lt, timetz/timetz, NULL)
__FUNC_OPCODE(timetz_le, timetz/timetz, NULL)
__FUNC_OPCODE(timetz_gt, timetz/timetz, NULL)
__FUNC_OPCODE(timetz_ge, timetz/timetz, NULL)

__FUNC_OPCODE(timestamp_eq, timestamp/timestamp, NULL)
__FUNC_OPCODE(timestamp_ne, timestamp/timestamp, NULL)
__FUNC_OPCODE(timestamp_lt, timestamp/timestamp, NULL)
__FUNC_OPCODE(timestamp_le, timestamp/timestamp, NULL)
__FUNC_OPCODE(timestamp_gt, timestamp/timestamp, NULL)
__FUNC_OPCODE(timestamp_ge, timestamp/timestamp, NULL)

__FUNC_OPCODE(timestamptz_eq, timestamptz/timestamptz, NULL)
__FUNC_OPCODE(timestamptz_ne, timestamptz/timestamptz, NULL)
__FUNC_OPCODE(timestamptz_lt, timestamptz/timestamptz, NULL)
__FUNC_OPCODE(timestamptz_le, timestamptz/timestamptz, NULL)
__FUNC_OPCODE(timestamptz_gt, timestamptz/timestamptz, NULL)
__FUNC_OPCODE(timestamptz_ge, timestamptz/timestamptz, NULL)

__FUNC_OPCODE(date_eq_timestamp, date/timestamp, NULL)
__FUNC_OPCODE(date_ne_timestamp, date/timestamp, NULL)
__FUNC_OPCODE(date_lt_timestamp, date/timestamp, NULL)
__FUNC_OPCODE(date_le_timestamp, date/timestamp, NULL)
__FUNC_OPCODE(date_gt_timestamp, date/timestamp, NULL)
__FUNC_OPCODE(date_ge_timestamp, date/timestamp, NULL)

__FUNC_OPCODE(timestamp_eq_date, timestamp/date, NULL)
__FUNC_OPCODE(timestamp_ne_date, timestamp/date, NULL)
__FUNC_OPCODE(timestamp_lt_date, timestamp/date, NULL)
__FUNC_OPCODE(timestamp_le_date, timestamp/date, NULL)
__FUNC_OPCODE(timestamp_gt_date, timestamp/date, NULL)
__FUNC_OPCODE(timestamp_ge_date, timestamp/date, NULL)

__FUNC_OPCODE(date_eq_timestamptz, date/timestamptz, NULL)
__FUNC_OPCODE(date_ne_timestamptz, date/timestamptz, NULL)
__FUNC_OPCODE(date_lt_timestamptz, date/timestamptz, NULL)
__FUNC_OPCODE(date_le_timestamptz, date/timestamptz, NULL)
__FUNC_OPCODE(date_gt_timestamptz, date/timestamptz, NULL)
__FUNC_OPCODE(date_ge_timestamptz, date/timestamptz, NULL)

__FUNC_OPCODE(timestamptz_eq_date, timestamptz/date, NULL)
__FUNC_OPCODE(timestamptz_ne_date, timestamptz/date, NULL)
__FUNC_OPCODE(timestamptz_lt_date, timestamptz/date, NULL)
__FUNC_OPCODE(timestamptz_le_date, timestamptz/date, NULL)
__FUNC_OPCODE(timestamptz_gt_date, timestamptz/date, NULL)
__FUNC_OPCODE(timestamptz_ge_date, timestamptz/date, NULL)

__FUNC_OPCODE(timestamp_eq_timestamptz, timestamp/timestamptz, NULL)
__FUNC_OPCODE(timestamp_ne_timestamptz, timestamp/timestamptz, NULL)
__FUNC_OPCODE(timestamp_lt_timestamptz, timestamp/timestamptz, NULL)
__FUNC_OPCODE(timestamp_le_timestamptz, timestamp/timestamptz, NULL)
__FUNC_OPCODE(timestamp_gt_timestamptz, timestamp/timestamptz, NULL)
__FUNC_OPCODE(timestamp_ge_timestamptz, timestamp/timestamptz, NULL)

__FUNC_OPCODE(timestamptz_eq_timestamp, timestamptz/timestamp, NULL)
__FUNC_OPCODE(timestamptz_ne_timestamp, timestamptz/timestamp, NULL)
__FUNC_OPCODE(timestamptz_lt_timestamp, timestamptz/timestamp, NULL)
__FUNC_OPCODE(timestamptz_le_timestamp, timestamptz/timestamp, NULL)
__FUNC_OPCODE(timestamptz_gt_timestamp, timestamptz/timestamp, NULL)
__FUNC_OPCODE(timestamptz_ge_timestamp, timestamptz/timestamp, NULL)

__FUNC_OPCODE(interval_eq, interval/interval, NULL)
__FUNC_OPCODE(interval_ne, interval/interval, NULL)
__FUNC_OPCODE(interval_lt, interval/interval, NULL)
__FUNC_OPCODE(interval_le, interval/interval, NULL)
